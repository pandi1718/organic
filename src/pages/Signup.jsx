  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "50px", zIndex: 1 }}>
        ...
        >
          <img src="/images/Signup/logo.png" alt="logo" style={{ width: "80%" }} />
        </div>
        ...
        >
          <h1 style={{ marginBottom: "20px", color: "#00210C" }}>Sign Up</h1>
